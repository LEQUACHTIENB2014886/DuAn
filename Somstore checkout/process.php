...
?>
                            ...
                            <p>
                                ...
                                <input id="email" name="email" placeholder="lequachtien123@gmail.com" type="email" AUTOCOMPLETE=OFF />
                            </p>
                            <p>
...
?>
                           ...
                           <p>
                                ...
                                <input id="address" name="address" placeholder="Binh Minh" type="text" AUTOCOMPLETE=OFF />
                            </p>
                            <p>
		  ...
		  <option value="ZW" countrynum="263">Zimbabwe</option>
                             ...
                             <p>
                                ...
                                <input id="city" name="city" placeholder="Vinh Long" type="text" AUTOCOMPLETE=OFF />
                            </p>														 

							<p> 
								 <label for="Address"> SĐT:</label>
                                <input id="phone" name="phone" placeholder="+84345324989" type="tel" AUTOCOMPLETE=OFF />
                            </p>
...
?>
							...
							<p>
                                ...
                                <input id="delivery" name="delivery" placeholder="Số 1536, Đường 3/2, ..." type=" text" AUTOCOMPLETE=OFF />
                            </p>
...
?>
							...
							<p>Chắc Chắn Thanh Toán ?
							</p>
                            <p class="submit">
							
                                <button id="registerButton" type="submit" name="submit"  title="Click On Payment Method">Xác Nhận</button>
                            </p>
                        </fieldset>
                    </form>
                </div>

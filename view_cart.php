 ...
 <div class="clear"></div>
	...
	<!-- Begin Navigation -->
		<div id="navigation">
			...
			<div class="shell">
				<ul>
					<li class="active"><a href="./Public/index.php" title="index.php">Home</a></li>
					   	   <li>
						<div class="dd">
							<ul>
								<li>
...
<div class="viewcart">
	...
	if(isset($_SESSION["cart_session"]))
    {
		...
		echo '<span class="midigta"><a  class="a-btn" href="../index.php?emptycart=1&return_url='.$current_url.'"><span class="a-btn-text">Tiếp tục mua sắm</span></a></span>';
		echo '<span class="check-out-txt">';

    	echo '</table>';
		echo '<span> <h4 class="pricewayn"> Tổng thiệt hại : <big style="color:green">'.$total.' đồng</big> </h4></span> ';
		echo '<span class="midigta"> <a  class="a-btn" href="Somstore checkout/process.php"> <span class="a-btn-text">Mua trên Web</span></a></span>';
		echo '</span>';
		echo '</form>'; 
